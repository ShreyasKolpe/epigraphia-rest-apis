...
class CleanerForm(forms.Form):
    input_str = forms.CharField(widget=forms.Textarea, label='Paste here the unclean text')
    ...
    process_n = forms.BooleanField(label='Choose whether to smartly process anusvara-consonant clusters', required=False)
